...
class riscv_instr_gen_config extends uvm_object;
  ...
  bit                    gen_csr_invalid_write = 0;   // Generate CSR writes to read-only CSRs
  ...
  `uvm_object_utils_begin(riscv_instr_gen_config)
    ...
    `uvm_field_int(gen_csr_invalid_write, UVM_DEFAULT)
  ...
  function new (string name = "");
    ...
    get_bool_arg_value("+gen_csr_invalid_write=", gen_csr_invalid_write);
