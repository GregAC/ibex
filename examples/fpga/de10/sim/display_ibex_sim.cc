...
int main(int argc, char **argv) {
  ...
  memutil.RegisterMemoryArea(
      "ram", "TOP.display_ibex_sim.display_ibex_top_i.u_ram.u_ram.gen_generic.u_impl_generic");
  ...
  svSetScope(svGetScopeFromName("TOP.display_ibex_sim.display_ibex_top_i"));
