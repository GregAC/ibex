...
typedef enum pmp_region_permissions {
  ...
  kPmpRegionPermissionsReadWriteMachineReadOnlyUser,
  kPmpRegionPermissionsSharedReadWrite,
  kPmpRegionPermissionsSharedExecuteOnly,
  kPmpRegionPermissionsReadExecuteMachineExecuteOnlyUser,
  kPmpRegionPermissionsSharedReadOnly,
